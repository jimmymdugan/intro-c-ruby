...
def parse_dna(str)
  ...
  nucleo = ["A", "C", "G", "T"] #accepted nucleotides
  dna = ""
  if str.empty?
    return dna
  end
...
#
def transcribe(dna)
  return dna.tr("T","U") #tr function replaces T with U
end
...
#codons.push(str[3..-1])
#return codons
  return (str.partition /.{3}$/)[0,2] #cleaner implementation
  end
...
def translate(codons)
  ...
  if codons.fetch(i).eql?(START_CODON) #when find start
