...
{
	// Your code here
	return pstring + 5;	// Fix this -- it is incorrect but allows the program to compile and run.
}
...
int *get_y_values( int *px, int m, int b, int number_of_x_values )
{
	// your code here
	if ( px )
		*px = 999 ;		// Bogus code that breaks unit test
	return (int *) 1 ;		// Fix this -- it is incorrect but allows the program to compile and run.
}
...
{
	return 5 ;			// Fix this -- it is incorrect but allows the program to compile and run.
}
